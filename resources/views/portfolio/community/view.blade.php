            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="POST"  action="{{ route('user.storeCommunity',$user = auth()->id()) }}" enctype="multipart/form-data">
                            @CSRF
                            {{method_field('POST')}}    
                            @method('POST')
                            ...
                            <div class="modal-body">
                                <table class="table table-borderless" style="font-size: medium;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input style="color: black;" type="date" class="form-control" id="startYear" name="startYear" required="" onchange="maxCheckDate(this)">
                                        </td>
                                    </tr>
                                    <!-- -------------------------  -------------------------  ------------------------- -->
                                    <tr>
                                        ...
                                        <td>
                                            <input style="color: black;" type="date" class="form-control" id="endYear" name="endYear" required="" onchange="maxCheckDate(this)">
                                        </td>
                                    </tr>
                                    <!-- -------------------------  -------------------------  ------------------------- -->
                                    <tr>
                                        ...
                                        <td>
                                            <input style="color: black;" type="text" class="form-control" id="venue" name="venue" required="">
                                        </td>
                                    </tr>
                                    <!-- -------------------------  -------------------------  ------------------------- -->
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input style="color: black;" type="date" class="form-control" id="when1" name="when1" required="" onchange="maxCheckDate(this)">
                                        </td>
                                    </tr>
                                    <!-- -------------------------  ----------------------  ------------------------- -->
                                    <tr>
                                    ...
                                    <tr>
                                        <th colspan="2">
                                            ...
                                            <textarea style="color: black;" rows="3" class="form-control" required="" id="overview1" name="overview1"></textarea>
                                        </th>
                                    </tr>
                                </table>        
                            </div>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST"  action="{{ route('user.updateCommunity',$user = auth()->id()) }}" enctype="multipart/form-data">
                @CSRF
                {{method_field('POST')}}    
                @method('POST')
                <div class="modal-header bg-danger text-white">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-borderless" style="font-size: medium;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input style="color: black;" type="date" class="form-control" id="when2" name="when2" required="" onchange="maxCheckDate(this)">
                            </td>
                        </tr>
                        <!-- -------------------------  ----------------------  ------------------------- -->
                        <tr>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{ route('user.deleteCommunity',$app=Auth::user()->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
...
<script>
    $(function () {
        ...
        $('#dataTable').on('click', '#edit', function () {
            ...
            $.get("/community/editcommunity"+id, function (data) {
