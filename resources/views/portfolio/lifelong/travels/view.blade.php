            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="POST"  action="{{ route('user.storeTravels',$user = auth()->id()) }}" enctype="multipart/form-data">
                            @CSRF
                            {{method_field('POST')}}    
                            @method('POST')
                            ...
                            <div class="modal-body">
                                <table class="table table-borderless" style="font-size: medium;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input style="color: black;" type="text" class="form-control" id="purpose" name="purpose" required="">
                                        </td>
                                    </tr>
                                    <!-- -------------------------  -------------------------  ------------------------- -->
                                    <tr>
                                        ...
                                        <td>
                                            <textarea  style="color: black;" class="form-control" rows="3" required="" id="learningExperience" name="learningExperience" ></textarea>
                                        </td>
                                    </tr>
                                    <!-- -------------------------  -------------------------  ------------------------- -->
                                    <tr>
            ...
            <table class="display table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th width="20%">Learning Experience</th>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST"  action="{{ route('user.updateTravels',$user = auth()->id()) }}" enctype="multipart/form-data">
                @CSRF
                {{method_field('POST')}}    
                @method('POST')
                <div class="modal-header bg-danger text-white">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-borderless" style="font-size: medium;">
                        ...
                        <tr>
                            ...
                            <td width="70%">
                                <input style="color: black;" type="text" class="form-control" id="location2" name="location2" required="">
                            </td>
                        </tr>
                        <!-- -------------------------  -------------------------  ------------------------- -->
                        <tr>
                            ...
                            <td>
                                <input style="color: black;" type="text" class="form-control" id="purpose2" name="purpose2" required="">
                            </td>
                        </tr>
                        <!-- -------------------------  -------------------------  ------------------------- -->
                        <tr>
                            ...
                            <td>
                                <textarea  style="color: black;" class="form-control" rows="3" required="" id="learningExperience2" name="learningExperience2" ></textarea>
                            </td>
                        </tr>
                        <!-- -------------------------  -------------------------  ------------------------- -->
                        <tr>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{ route('user.deleteTravels',$app=Auth::user()->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
...
<script>
    $(function () {
        ...
        $('#dataTable').on('click', '#edit', function () {
            ...
            $.get("/travels/edittravels"+id, function (data) {
                $('#editModal').modal('show');
                $('input[id=id2]').val(data.id);
                $('input[id=user_id2]').val(data.user_id);


                $('input[id=location2]').val(data.location);
                $('input[id=purpose2]').val(data.purpose);
                $('textarea[id=learningExperience2]').val(data.learningExperience);
