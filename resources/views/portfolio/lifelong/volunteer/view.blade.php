            ...
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="POST"  action="{{ route('user.storeVolunteer',$user = auth()->id()) }}" enctype="multipart/form-data">
                            @CSRF
                            {{method_field('POST')}}    
                            @method('POST')
                            ...
                            <div class="modal-body">
                                <table class="table table-borderless" width="100%" style="font-size: medium;">
                                    ...
                                    <tr>
                                        <th>
                                            Volunteer Title<i style="color: red;">*</i>
                                        </th>
                                        <td>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST"  action="{{ route('user.updateVolunteer',$user = auth()->id()) }}" enctype="multipart/form-data">
                @CSRF
                {{method_field('POST')}}    
                @method('POST')
                <div class="modal-header bg-danger text-white">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{ route('user.deleteVolunteer',$app=Auth::user()->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
...
<script>
    $(function () {
        ...
        $('#dataTable').on('click', '#edit', function () {
            ...
            $.get("/volunteer/editvolunteer"+id, function (data) {
