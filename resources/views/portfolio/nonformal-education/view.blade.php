			...
			<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						<form method="POST"  action="{{ route('user.storenonFormalEducation',$user = auth()->id()) }}" enctype="multipart/form-data">
							<div class="modal-header bg-danger">
								<h5 class="modal-title text-white" id="addModalLabel">Non-Formal Education Details</h5>
							...
							<div class="modal-body">
								...
								<table class="table table-borderless" style="font-size: medium;">
									...
									<tr>
										...
										<td>
											<input style="color: black;" type="text" class="form-control" id="trainingProgram" name="trainingProgram" required="">
										</td>
									</tr>
									<!-- --------------------  --------------------  -------------------- -->
									<tr>
									...
									<tr>
										...
										<td>
											<input style="color: black;" type="text" class="form-control" id="certifyingAgency" name="certifyingAgency" required="">
										</td>
									</tr>
									<!-- --------------------  --------------------  -------------------- -->
									<tr>
										...
										<td>
											<input style="color: black;" type="date" class="form-control" id="startYear" name="startYear" onchange="maxCheckDate(this);" required="">
										</td>
									</tr>
									<!-- --------------------  --------------------  -------------------- -->
									<tr>
										...
										<td>
											<input style="color: black;" type="date" class="form-control" id="endYear" name="endYear" onchange="maxCheckDate(this);" required="">
										</td>
									</tr>
									<!-- --------------------  --------------------  -------------------- -->
									<tr>
		...
		<div class="table-responsive">
			<table class="table table-bordered display" id="dataTable" width="100%" cellspacing="0">
				...
				<tbody>
					...
					<!-- --------------------  --------------------  -------------------- -->
					<tr>
						<td>{{$com->trainingProgram}}</td>
						<td>{{$com->certificateTitle}}</td>
						<td>{{$com->certifyingAgency}}</td>
						<td>
							{{$com->duration}} 
							@if ( $com->duration > 1 )
								Months
						...
						<td><a target="_blank" href="/uploads/transcript/{{$com->file}}"  style="text-decoration: none;">{{$com->file}}</a></td>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="addImageLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<form id="userForm" name="userForm" method="POST"  action="{{ route('user.updatenonFormalEducation',$user = auth()->id()) }}" enctype="multipart/form-data">
				<div class="modal-header bg-danger">
					<h5 class="modal-title text-white" id="addModalLabel">Non-Formal Education Details</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true" class="text-white">&times;</span>
				...
				<div class="modal-body">
					...
					<table class="table table-borderless" style="font-size: medium;">
						...
						<tr>
							...
							<td>
								<input style="color: black;" type="text" class="form-control" id="trainingProgram2" name="trainingProgram2" required="">
							</td>
						</tr>
						<!-- --------------------  --------------------  -------------------- -->
						<tr>
						...
						<tr>
							...
							<td>
								<input style="color: black;" type="text" class="form-control" id="certifyingAgency2" name="certifyingAgency2" required="">
							</td>
						</tr>
						<!-- --------------------  --------------------  -------------------- -->
						<tr>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form action="{{ route('user.deletenonFormalEducation',$app=Auth::user()->id) }}" method="POST">
					@csrf
					@method('DELETE')
...
<script type="text/javascript">
	...
	$(function () {
		...
		$('#dataTable').on('click', '#edit', function () {
			...
			$.get("/non-formal-education/editnonformaleducation/"+id, function (data) {
				$('#editModal').modal('show');
				$('input[id=id2]').val(data.id);
				$('input[id=user_id2]').val(data.user_id);
				$('input[id=trainingProgram2]').val(data.trainingProgram);
				$('input[id=certificateTitle2]').val(data.certificateTitle);
				$('input[id=certifyingAgency2]').val(data.certifyingAgency);
				$('input[id=startYear2]').val(data.startYear);
				$('input[id=endYear2]').val(data.endYear);
				$('input[id=duration2]').val(data.duration);
